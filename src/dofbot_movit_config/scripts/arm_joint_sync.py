...
class ArmJointSync:
    JointMap = {'base_joint': {"idx": 1, 'bias': 90, 'range': [-90, 90], 'init': 0},
                'shoulder_joint': {"idx": 2, 'bias': 95, 'range': [-85, 85], 'init': 0.2834},
                'elbow_joint': {"idx": 3, 'bias': 90, 'range': [-60, 90], 'init': -0.9736},
                'wrist_flex_joint': {"idx": 4, 'bias': 90, 'range': [-90, 0], 'init': -1.4648},
                'wrist_rot_joint': {"idx": 5, 'bias': 90, 'range': [-90, 0], 'init': 0},
                'gripper_attach_joint': {"idx": 6, 'bias': 90, 'range': [-90, 0], 'init': 0}
                }

    def __init__(self):
        self.joint_names = ['base_joint', 'shoulder_joint', 'elbow_joint', 'wrist_flex_joint', 'wrist_rot_joint','gripper_attach_joint']
